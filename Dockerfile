...
# Setup madara
RUN chmod +x ./madara
RUN ./madara setup --chain=dev --base-path=/.madara

EXPOSE 9944 9615 30333

# Start madarae
CMD ["./madara", "--chain=dev", "--base-path=/.madara", "--force-authoring","--alice","--rpc-external","--rpc-methods=unsafe", "--base-path=/.madara"]